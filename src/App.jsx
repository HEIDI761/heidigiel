...
function App() {
  ...
  return (
    <div>
      ...
      {data?.highlight && (
        <div className="bg-primary text-background hover:bg-accent fixed right-0 bottom-0 z-50 m-8 flex w-min -rotate-8 cursor-pointer justify-end rounded-full p-8 text-center font-serif text-xl italic transition-all duration-300 hover:scale-105 hover:rotate-3">
