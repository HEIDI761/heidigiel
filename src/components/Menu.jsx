...
export default function Menu() {
  ...
  return (
    <>
      <nav className="pointer-events-none fixed inset-0 flex h-screen w-full flex-col justify-between overflow-hidden px-4 pt-3 pb-6 uppercase drop-shadow-sm">
            ...
            >
              <g id="Layer_2-2" data-name="Layer 2">
                <g>
                  ...
                  <path
                    class="cls-1"
                    d="M542.58,43.69h-22.48c-12.63-22.79-40.91-48.53-68.13-32.56-22.67,13.3-19.78,39.8-9.44,60.33,13.8,27.41,48.81,63.68,79.68,36.22l.05-18.9-27.92-12.78-.47-2.31h49.45v49.12l-1.76,1.04-18.13-13.45c-4.61,2.17-8.41,5.45-13.32,7.67-50.03,22.65-102.48-25.17-84.44-77.02,11.06-31.79,46.42-48.45,78.34-37.89,17.81,5.89,34.54,21.89,38.56,40.53Z"
                  />
                  <path
                    class="cls-1"
                    d="M727.66,2.44c2.27,2.17-10.29,9.25-11.24,10.88v106.12h22.85c6.94-8.17,12.6-18.97,19.55-26.94.66-.75,1.81-2.55,2.92-2.31l1.17,2.59-3.03,28.16h-76.43c.84-4.47,11.24-7.75,11.97-11.64l.07-94.53c-.45-3.69-8.86-6.94-11.25-9.74-.81-.95-.98-1.26-.78-2.59h44.21Z"
                  />
                  <path
                    class="cls-1"
                    d="M668.46,2.44l2.99,30.75-3.35-.76-20.25-27.73h-23.6c1.17,12.9.55,32.48,11.23,41.63,1.94,1.66,6.48,5.03,9,3.77,1.76-.88,7.73-11.91,9.7-14.16l2.29-.49v36c-1.02.03-1.46.26-2.29-.5-1.25-1.13-7.23-11.74-8.84-14.27-.48-.76-.82-1.57-.86-2.48h-19.11c-1.05.66-1.06,1.51-1.18,2.61-.26,2.44.55,11.97.81,15.01.89,10.32,3.29,25.04,8.97,33.78,3.9,6.01,12.19,13.41,19.49,13.51l17.99-24.79,3-1.11-3.1,30.64c-40.98,1.45-69.55-31-67.33-71.14h35.22l-7.76-3.11c-18.41-8.48-28.38-27.06-27.46-47.14h64.44Z"
                  />
                  <path
                    class="cls-1"
                    d="M230.87,120.94h-44.21c-.2-1.33-.03-1.64.78-2.59,1.48-1.73,9.71-6.3,10.29-7.31l.15-96.95c-.38-3.01-10.38-7.55-11.06-8.79-.44-.8-.07-1.94-.16-2.85h43.09c.73.73,1.58,1.01.77,2.26-1.44,2.23-11.12,6.66-11.64,9.35l.7,96.81c3.31,3.47,9.55,5.51,11.29,10.07Z"
                  />
                  <path
                    class="cls-1"
                    d="M378.48,2.44c2.53,2.45-11.16,9.01-11.23,11.64l.15,96.95c.58,1.01,8.82,5.59,10.29,7.31.81.95.98,1.26.78,2.59h-44.21c.84-4.47,11.24-7.75,11.97-11.64l.07-94.53c-.45-3.69-8.86-6.94-11.25-9.74-.81-.95-.98-1.26-.78-2.59h44.21Z"
                  />
                  <path
                    class="cls-1"
                    d="M595.78,120.94h-44.21c-.2-1.33-.03-1.64.78-2.59,1.48-1.73,9.71-6.3,10.29-7.31l.15-96.95c-.38-3.01-10.38-7.55-11.06-8.79-.44-.8-.07-1.94-.16-2.85h43.09c.73.73,1.58,1.01.77,2.26-1.44,2.23-11.12,6.66-11.64,9.35l.7,96.81c3.31,3.47,9.55,5.51,11.29,10.07Z"
                  />
                </g>
              </g>
            </svg>
